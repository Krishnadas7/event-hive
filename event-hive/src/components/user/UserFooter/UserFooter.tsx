...
const  UserFooter:React.FC = () => {
  return (
    ...
    <div className='w-full flex py-10   max-sm:flex-col bg-white mt-16 justify-around text-black text-sm'>
        ...
        <div className='flex sm:flex-col sm:items-center sm:justify-center justify-center items-center mb-11'>
        ...
        <div className='flex sm:flex-col sm:justify-center sm:items-center flex-col'>
